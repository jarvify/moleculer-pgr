    ...
    export type PgrCount = number;
          ...
          export type testMultiplePrimariesInput = Parameters<pgr.Query['testMultiplePrimaries']>[0];
            export type countTestMultiplePrimariesInput = Parameters<pgr.Query['testMultiplePrimaries']>[0];
            export type firstTestMultiplePrimariesInput = Parameters<pgr.Query['testMultiplePrimaries']>[0];
            export type findTestMultiplePrimariesInput = Parameters<pgr.Query['testMultiplePrimaries']>[0];
          ...
          export type testMultiplePrimaryInput = Parameters<pgr.Query['testMultiplePrimary']>[0];
          ...
          export type createTestMultiplePrimaryInput = Parameters<pgr.Mutation['createTestMultiplePrimary']>[0]['input']['testMultiplePrimary']
          export type createTestPrimaryInput = Parameters<pgr.Mutation['createTestPrimary']>[0]['input']['testPrimary']
          ...
          export type updateAccountInput = Omit<Parameters<pgr.Mutation['updateAccount']>[0]['input'], 'clientMutationId'>
                export type upsertAccountInput = { query: customPgr.accountsInput, create: customPgr.createAccountInput  , update:  customPgr.updateAccountInput['patch'] };
          export type updateMigrationInput = Omit<Parameters<pgr.Mutation['updateMigration']>[0]['input'], 'clientMutationId'>
                export type upsertMigrationInput = { query: customPgr.migrationsInput, create: customPgr.createMigrationInput  , update:  customPgr.updateMigrationInput['patch'] };
          export type updateTestMultiplePrimaryInput = Omit<Parameters<pgr.Mutation['updateTestMultiplePrimary']>[0]['input'], 'clientMutationId'>
                export type upsertTestMultiplePrimaryInput = { query: customPgr.testMultiplePrimariesInput, create: customPgr.createTestMultiplePrimaryInput  , update:  customPgr.updateTestMultiplePrimaryInput['patch'] };
          export type updateTestPrimaryInput = Omit<Parameters<pgr.Mutation['updateTestPrimary']>[0]['input'], 'clientMutationId'>
                export type upsertTestPrimaryInput = { query: customPgr.testPrimariesInput, create: customPgr.createTestPrimaryInput  , update:  customPgr.updateTestPrimaryInput['patch'] };
          export type updateUserInput = Omit<Parameters<pgr.Mutation['updateUser']>[0]['input'], 'clientMutationId'>
                export type upsertUserInput = { query: customPgr.userSearchInput, create: customPgr.createUserInput  , update:  customPgr.updateUserInput['patch'] };
          ...
          export type updateUserProfileInput = Omit<Parameters<pgr.Mutation['updateUserProfile']>[0]['input'], 'clientMutationId'>
                export type upsertUserProfileInput = { query: customPgr.userProfilesInput, create: customPgr.createUserProfileInput  , update:  customPgr.updateUserProfileInput['patch'] };
          ...
          export type deleteTestMultiplePrimaryInput = Omit<Parameters<pgr.Mutation['deleteTestMultiplePrimary']>[0]['input'], 'clientMutationId'>
          export type deleteTestPrimaryInput = Omit<Parameters<pgr.Mutation['deleteTestPrimary']>[0]['input'], 'clientMutationId'>
        ...
        export type TestMultiplePrimary = moleculerPgr.StrictOmit<pgr.TestMultiplePrimary, never>
    ...
    export namespace PgrExtend {
        ...
        export type TestMultiplePrimary<T extends keyof pgr.TestMultiplePrimary, P, Optional extends true | false = true
        > = Optional extends true
          ? {
              [K in T]?: P;
            }
        ...
        export type TestPrimary<T extends keyof pgr.TestPrimary, P, Optional extends true | false = true
        > = Optional extends true
          ? {
              [K in T]?: P;
            }
    ...
    export type PgrActions = [
            ...
            moleculerTs.Action<'firstAccounts', customPgr.accountsInput, customPgr.PgrNodeOptional<customPgr.Account>>,
          
              moleculerTs.Action<'firstAccounts.user', customPgr.firstAccounts_userInput, customPgr.PgrNodeOptional<customPgr.User>>,
            ...
            moleculerTs.Action<'firstMigrations', customPgr.migrationsInput, customPgr.PgrNodeOptional<customPgr.Migration>>,
          
            moleculerTs.Action<'findMigrations', customPgr.findMigrationsInput, customPgr.PgrNodeArray<customPgr.Migration>>,
          
            moleculerTs.Action<'testMultiplePrimaries', customPgr.testMultiplePrimariesInput, customPgr.PgrConnection<customPgr.TestMultiplePrimary>>,
          
            moleculerTs.Action<'countTestMultiplePrimaries', customPgr.countTestMultiplePrimariesInput, customPgr.PgrCount>,
          
            moleculerTs.Action<'firstTestMultiplePrimaries', customPgr.testMultiplePrimariesInput, customPgr.PgrNodeOptional<customPgr.TestMultiplePrimary>>,
          
            moleculerTs.Action<'findTestMultiplePrimaries', customPgr.findTestMultiplePrimariesInput, customPgr.PgrNodeArray<customPgr.TestMultiplePrimary>>,
          
            moleculerTs.Action<'testPrimaries', customPgr.testPrimariesInput, customPgr.PgrConnection<customPgr.TestPrimary>>,
          
            moleculerTs.Action<'countTestPrimaries', customPgr.countTestPrimariesInput, customPgr.PgrCount>,
          
            moleculerTs.Action<'firstTestPrimaries', customPgr.testPrimariesInput, customPgr.PgrNodeOptional<customPgr.TestPrimary>>,
          
            moleculerTs.Action<'findTestPrimaries', customPgr.findTestPrimariesInput, customPgr.PgrNodeArray<customPgr.TestPrimary>>,
            ...
            moleculerTs.Action<'firstUsers', customPgr.usersInput, customPgr.PgrNodeOptional<customPgr.User>>,
            ...
            moleculerTs.Action<'firstUserProfiles', customPgr.userProfilesInput, customPgr.PgrNodeOptional<customPgr.UserProfile>>,
            ...
            moleculerTs.Action<'account', customPgr.accountInput, customPgr.PgrNodeOptional<customPgr.Account>>,
              ...
              moleculerTs.Action<'account.user', customPgr.account_userInput, customPgr.PgrNodeOptional<customPgr.User>>,
            
            moleculerTs.Action<'migration', customPgr.migrationInput, customPgr.PgrNodeOptional<customPgr.Migration>>,
          
            moleculerTs.Action<'testMultiplePrimary', customPgr.testMultiplePrimaryInput, customPgr.PgrNodeOptional<customPgr.TestMultiplePrimary>>,
          
            moleculerTs.Action<'testPrimary', customPgr.testPrimaryInput, customPgr.PgrNodeOptional<customPgr.TestPrimary>>,
            ...
            moleculerTs.Action<'firstUserSearch', customPgr.userSearchInput, customPgr.PgrNodeOptional<customPgr.User>>,
          ...
          moleculerTs.Action<'createTestMultiplePrimary', customPgr.createTestMultiplePrimaryInput, customPgr.PgrNode<customPgr.TestMultiplePrimary>>,
        
          moleculerTs.Action<'createTestPrimary', customPgr.createTestPrimaryInput, customPgr.PgrNode<customPgr.TestPrimary>>,
          ...
          moleculerTs.Action<'updateAccount', customPgr.updateAccountInput, customPgr.PgrNodeOptional<customPgr.Account>>,
                ...
                moleculerTs.Action<'upsertAccount', customPgr.upsertAccountInput, customPgr.PgrNode<customPgr.Account>>,
              
          moleculerTs.Action<'updateMigration', customPgr.updateMigrationInput, customPgr.PgrNodeOptional<customPgr.Migration>>,
        
                moleculerTs.Action<'upsertMigration', customPgr.upsertMigrationInput, customPgr.PgrNode<customPgr.Migration>>,
              
          moleculerTs.Action<'updateTestMultiplePrimary', customPgr.updateTestMultiplePrimaryInput, customPgr.PgrNodeOptional<customPgr.TestMultiplePrimary>>,
        
                moleculerTs.Action<'upsertTestMultiplePrimary', customPgr.upsertTestMultiplePrimaryInput, customPgr.PgrNode<customPgr.TestMultiplePrimary>>,
              
          moleculerTs.Action<'updateTestPrimary', customPgr.updateTestPrimaryInput, customPgr.PgrNodeOptional<customPgr.TestPrimary>>,
        
                moleculerTs.Action<'upsertTestPrimary', customPgr.upsertTestPrimaryInput, customPgr.PgrNode<customPgr.TestPrimary>>,
              
          moleculerTs.Action<'updateUser', customPgr.updateUserInput, customPgr.PgrNodeOptional<customPgr.User>>,
        
                moleculerTs.Action<'upsertUser', customPgr.upsertUserInput, customPgr.PgrNode<customPgr.User>>,
          ...
          moleculerTs.Action<'updateUserProfile', customPgr.updateUserProfileInput, customPgr.PgrNodeOptional<customPgr.UserProfile>>,
                ...
                moleculerTs.Action<'upsertUserProfile', customPgr.upsertUserProfileInput, customPgr.PgrNode<customPgr.UserProfile>>,
          ...
          moleculerTs.Action<'deleteTestMultiplePrimary', customPgr.deleteTestMultiplePrimaryInput, customPgr.PgrNodeOptional<customPgr.TestMultiplePrimary>>,
        
          moleculerTs.Action<'deleteTestPrimary', customPgr.deleteTestPrimaryInput, customPgr.PgrNodeOptional<customPgr.TestPrimary>>,
    ...
    export const pgrQuery = {
            ...
            'accounts': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrConnection<customPgr.Account>>>()),
          
            'countAccounts': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ totalCount: customPgr.PgrCount }>>()),
          
              'firstAccounts.user': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: { user: customPgr.User } }>>()),
            
            'findAccounts': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: customPgr.Account }>>()),
          
            'migrations': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrConnection<customPgr.Migration>>>()),
          
            'countMigrations': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ totalCount: customPgr.PgrCount }>>()),
          
            'findMigrations': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: customPgr.Migration }>>()),
          
            'testMultiplePrimaries': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrConnection<customPgr.TestMultiplePrimary>>>()),
          
            'countTestMultiplePrimaries': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ totalCount: customPgr.PgrCount }>>()),
          
            'findTestMultiplePrimaries': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: customPgr.TestMultiplePrimary }>>()),
          
            'testPrimaries': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrConnection<customPgr.TestPrimary>>>()),
          
            'countTestPrimaries': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ totalCount: customPgr.PgrCount }>>()),
          
            'findTestPrimaries': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: customPgr.TestPrimary }>>()),
          
            'users': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrConnection<customPgr.User>>>()),
          
            'countUsers': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ totalCount: customPgr.PgrCount }>>()),
          
              'firstUsers.profile': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: { profile: customPgr.UserProfile } }>>()),
            
            'findUsers': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: customPgr.User }>>()),
          
            'userProfiles': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrConnection<customPgr.UserProfile>>>()),
          
            'countUserProfiles': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ totalCount: customPgr.PgrCount }>>()),
          
              'firstUserProfiles.user': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: { user: customPgr.User } }>>()),
            
            'findUserProfiles': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: customPgr.UserProfile }>>()),
          
            'account': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.Account>>>()),
          
            'migration': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.Migration>>>()),
          
            'testMultiplePrimary': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.TestMultiplePrimary>>>()),
          
            'testPrimary': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.TestPrimary>>>()),
          
            'user': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.User>>>()),
          
            'userByEmail': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.User>>>()),
          
            'userByFirstNameAndLastName': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.User>>>()),
          
            'userByUserProfileId': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.User>>>()),
          
            'userProfile': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrNodeOptional<customPgr.UserProfile>>>()),
          
            'userSearch': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<customPgr.PgrConnection<customPgr.User>>>()),
          
            'countUserSearch': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ totalCount: customPgr.PgrCount }>>()),
          
              'firstUserSearch.profile': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: { profile: customPgr.UserProfile } }>>()),
            
            'findUserSearch': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{ nodes: customPgr.User }>>()),
          
            'createAccount': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{account: customPgr.PgrNode<customPgr.Account>} >>()),
          
            'createMigration': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{migration: customPgr.PgrNode<customPgr.Migration>} >>()),
          
            'createTestMultiplePrimary': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{testMultiplePrimary: customPgr.PgrNode<customPgr.TestMultiplePrimary>} >>()),
          
            'createTestPrimary': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{testPrimary: customPgr.PgrNode<customPgr.TestPrimary>} >>()),
          
            'createUser': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNode<customPgr.User>} >>()),
          
            'createUserProfile': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{userProfile: customPgr.PgrNode<customPgr.UserProfile>} >>()),
          
            'updateAccount': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{account: customPgr.PgrNodeOptional<customPgr.Account>} >>()),
          
            'updateMigration': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{migration: customPgr.PgrNodeOptional<customPgr.Migration>} >>()),
          
            'updateTestMultiplePrimary': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{testMultiplePrimary: customPgr.PgrNodeOptional<customPgr.TestMultiplePrimary>} >>()),
          
            'updateTestPrimary': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{testPrimary: customPgr.PgrNodeOptional<customPgr.TestPrimary>} >>()),
          
            'updateUser': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNodeOptional<customPgr.User>} >>()),
          
            'updateUserByEmail': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNodeOptional<customPgr.User>} >>()),
          
            'updateUserByFirstNameAndLastName': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNodeOptional<customPgr.User>} >>()),
          
            'updateUserByUserProfileId': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNodeOptional<customPgr.User>} >>()),
          
            'updateUserProfile': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{userProfile: customPgr.PgrNodeOptional<customPgr.UserProfile>} >>()),
          
            'deleteAccount': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{account: customPgr.PgrNodeOptional<customPgr.Account>} >>()),
          
            'deleteMigration': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{migration: customPgr.PgrNodeOptional<customPgr.Migration>} >>()),
          
            'deleteTestMultiplePrimary': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{testMultiplePrimary: customPgr.PgrNodeOptional<customPgr.TestMultiplePrimary>} >>()),
          
            'deleteTestPrimary': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{testPrimary: customPgr.PgrNodeOptional<customPgr.TestPrimary>} >>()),
          
            'deleteUser': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNodeOptional<customPgr.User>} >>()),
          
            'deleteUserByEmail': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNodeOptional<customPgr.User>} >>()),
          
            'deleteUserByFirstNameAndLastName': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNodeOptional<customPgr.User>} >>()),
          
            'deleteUserByUserProfileId': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{user: customPgr.PgrNodeOptional<customPgr.User>} >>()),
          
            'deleteUserProfile': moleculerPgr.shapeToGql(moleculerPgr.shape<NonNullable<{userProfile: customPgr.PgrNodeOptional<customPgr.UserProfile>} >>()),
      ...
      actions: {
          ...
          async accounts(this: any, ctx: any) {
            ...
            async firstAccounts(this: any, ctx: any) {
              ...
              const result = await ctx.call(`${this.name}.findAccounts`, {first, last, ...params});
              if (result.length === 0) {
                return null
              } 
              return result[0]
          ...
          async migrations(this: any, ctx: any) {
            ...
            async firstMigrations(this: any, ctx: any) {
              ...
              const result = await ctx.call(`${this.name}.findMigrations`, {first, last, ...params});
              if (result.length === 0) {
                return null
              } 
              return result[0]
          ...
          async testMultiplePrimaries(this: any, ctx: any) {
            ...
            async firstTestMultiplePrimaries(this: any, ctx: any) {
              ...
              const result = await ctx.call(`${this.name}.findTestMultiplePrimaries`, {first, last, ...params});
              if (result.length === 0) {
                return null
              } 
              return result[0]
          ...
          async testPrimaries(this: any, ctx: any) {
            ...
            async firstTestPrimaries(this: any, ctx: any) {
              ...
              const result = await ctx.call(`${this.name}.findTestPrimaries`, {first, last, ...params});
              if (result.length === 0) {
                return null
              } 
              return result[0]
          ...
          async users(this: any, ctx: any) {
            ...
            async firstUsers(this: any, ctx: any) {
              ...
              const result = await ctx.call(`${this.name}.findUsers`, {first, last, ...params});
              if (result.length === 0) {
                return null
              } 
              return result[0]
          ...
          async userProfiles(this: any, ctx: any) {
            ...
            async firstUserProfiles(this: any, ctx: any) {
              ...
              const result = await ctx.call(`${this.name}.findUserProfiles`, {first, last, ...params});
              if (result.length === 0) {
                return null
              } 
              return result[0]
          ...
          async userSearch(this: any, ctx: any) {
            ...
            async firstUserSearch(this: any, ctx: any) {
              ...
              const result = await ctx.call(`${this.name}.findUserSearch`, {first, last, ...params});
              if (result.length === 0) {
                return null
              } 
              return result[0]
          ...
          async createTestMultiplePrimary(this: any, ctx: any) {
            ...
            const result = await client.mutation.createTestMultiplePrimary(data, query); 
          ...
          async updateAccount(this: any, ctx: any) {
            ...
            return result!['account'];
                ...
                async 'upsertAccount'(this: any, ctx: any) {
                  const params = ctx.params;
                  let node = await ctx.call(`${this.name}.firstAccounts`, { ...params.query });
                  console.log('node', node)
                  if (!node) {
                    node = await ctx.call(`${this.name}.createAccount`, { ...params.create });
                  } else {
                    const primaryQuery = getPartialObject(node, ['id']);
                    node = await ctx.call(`${this.name}.updateAccount`, { ...primaryQuery, patch: params.update });
          ...
          async updateMigration(this: any, ctx: any) {
            ...
            return result!['migration'];
                ...
                async 'upsertMigration'(this: any, ctx: any) {
                  const params = ctx.params;
                  let node = await ctx.call(`${this.name}.firstMigrations`, { ...params.query });
                  console.log('node', node)
                  if (!node) {
                    node = await ctx.call(`${this.name}.createMigration`, { ...params.create });
                  } else {
                    const primaryQuery = getPartialObject(node, ['id']);
                    node = await ctx.call(`${this.name}.updateMigration`, { ...primaryQuery, patch: params.update });
          ...
          async updateTestMultiplePrimary(this: any, ctx: any) {
            ...
            const result = await client.mutation.updateTestMultiplePrimary(data, query); 
            return result!['testMultiplePrimary'];
          },
                async 'upsertTestMultiplePrimary'(this: any, ctx: any) {
                  const params = ctx.params;
                  let node = await ctx.call(`${this.name}.firstTestMultiplePrimaries`, { ...params.query });
                  console.log('node', node)
                  if (!node) {
                    node = await ctx.call(`${this.name}.createTestMultiplePrimary`, { ...params.create });
                  } else {
                    const primaryQuery = getPartialObject(node, ['oneId','twoId']);
                    node = await ctx.call(`${this.name}.updateTestMultiplePrimary`, { ...primaryQuery, patch: params.update });

                    if (!node) {
                      return await ctx.callSvc(`${this.name}.upsertTestMultiplePrimary`, ctx.params);
                    }
                  }
          ...
          async updateTestPrimary(this: any, ctx: any) {
            ...
            return result!['testPrimary'];
                ...
                async 'upsertTestPrimary'(this: any, ctx: any) {
                  const params = ctx.params;
                  let node = await ctx.call(`${this.name}.firstTestPrimaries`, { ...params.query });
                  console.log('node', node)
                  if (!node) {
                    node = await ctx.call(`${this.name}.createTestPrimary`, { ...params.create });
                  } else {
                    const primaryQuery = getPartialObject(node, ['primary']);
                    node = await ctx.call(`${this.name}.updateTestPrimary`, { ...primaryQuery, patch: params.update });

                    if (!node) {
                      return await ctx.callSvc(`${this.name}.upsertTestPrimary`, ctx.params);
                    }
                  }
          ...
          async updateUser(this: any, ctx: any) {
            ...
            return result!['user'];
                ...
                async 'upsertUser'(this: any, ctx: any) {
                  const params = ctx.params;
                  let node = await ctx.call(`${this.name}.firstUserSearch`, { ...params.query });
                  console.log('node', node)
                  if (!node) {
                    node = await ctx.call(`${this.name}.createUser`, { ...params.create });
                  } else {
                    const primaryQuery = getPartialObject(node, ['id']);
                    node = await ctx.call(`${this.name}.updateUser`, { ...primaryQuery, patch: params.update });
          ...
          async updateUserByFirstNameAndLastName(this: any, ctx: any) {
            ...
            const result = await client.mutation.updateUserByFirstNameAndLastName(data, query); 
            return result!['user'];
          },
          async updateUserByUserProfileId(this: any, ctx: any) {
            ...
            const result = await client.mutation.updateUserByUserProfileId(data, query); 
            return result!['user'];
          },
          async updateUserProfile(this: any, ctx: any) {
            ...
            return result!['userProfile'];
                ...
                async 'upsertUserProfile'(this: any, ctx: any) {
                  const params = ctx.params;
                  let node = await ctx.call(`${this.name}.firstUserProfiles`, { ...params.query });
                  console.log('node', node)
                  if (!node) {
                    node = await ctx.call(`${this.name}.createUserProfile`, { ...params.create });
                  } else {
                    const primaryQuery = getPartialObject(node, ['id']);
                    node = await ctx.call(`${this.name}.updateUserProfile`, { ...primaryQuery, patch: params.update });

                    if (!node) {
                      return await ctx.callSvc(`${this.name}.upsertUserProfile`, ctx.params);
                    }
                  }
          ...
          async deleteTestMultiplePrimary(this: any, ctx: any) {
            ...
            const result = await client.mutation.deleteTestMultiplePrimary(data, query); 
            return result!['testMultiplePrimary'];
          },
          ...
          async deleteUserByFirstNameAndLastName(this: any, ctx: any) {
            ...
            const result = await client.mutation.deleteUserByFirstNameAndLastName(data, query); 
            return result!['user'];
          },
          async deleteUserByUserProfileId(this: any, ctx: any) {
            ...
            const result = await client.mutation.deleteUserByUserProfileId(data, query); 
            return result!['user'];
          },
