...
declare namespace Moleculer {
  ...
  type ActionHandler<T = any> = ((ctx: Context) => PromiseLike<T> | T) &
    ThisType<Service>;
  ...
  type MetricsOptions = {
    params?: boolean | string[] | MetricsParamsFuncType;
    meta?: boolean | string[] | MetricsMetaFuncType;
  };
  ...
  class Service<S = ServiceSettingSchema> implements ServiceSchema {
    ...
    waitForServices(
      serviceNames: ServiceNamesGroup,
      timeout?: number,
      interval?: number,
    ): PromiseLike<void>;
...
Service.waitForServices({})
  ...
  interface BrokerOptions {
    ...
    logger?:
      | ((bindings: LoggerBindings) => LoggerInstance)
      | LoggerInstance
      | boolean;
  ...
  type FallbackHandler = (
    ctx: Context,
    err: Errors.MoleculerError,
  ) => PromiseLike<any>;
  type FallbackResponse = string | number | GenericObject;
  type FallbackResponseHandler = (
    ctx: Context,
    err: Errors.MoleculerError,
  ) => PromiseLike<any>;
  ...
  class ServiceBroker {
     ...
     */
    mcall<T = any>(
      def: Array<CallDefinition> | { [name: string]: CallDefinition },
    ): PromiseLike<Array<T> | T>;
    ...
    ping(): PromiseLike<PongResponse[]>;
    ping(nodeID: string, timeout?: number): PromiseLike<PongResponse[]>;
    ping(nodeID: Array<string>, timeout?: number): PromiseLike<PongResponse[]>;
  ...
  namespace Transporters {
    type MessageHandler = ((cmd: string, msg: any) => PromiseLike<void>) &
      ThisType<Base>;
    type AfterConnectHandler = ((wasReconnect?: boolean) => PromiseLike<void>) &
      ThisType<Base>;
  ...
  interface Transit {
    ...
    messageHandler(
      cmd: string,
      msg: GenericObject,
    ): boolean | PromiseLike<void> | undefined;
    request(ctx: Context): PromiseLike<void>;
    sendBroadcastEvent(
      nodeID: string,
      eventName: string,
      data: GenericObject,
      nodeGroups: GenericObject,
    ): void;
    sendBalancedEvent(
      eventName: string,
      data: GenericObject,
